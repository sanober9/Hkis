...
$getdata="SELECT * from files order by date desc";
    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image" src="assets/img/logo.png" class="header-logo" /> <span class="logo-name"></span>
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="index.html" data-toggle="modal" data-target="#login_modal" class="nav-link"><i data-feather="monitor"></i><span>Add File</span></a>
                        </li>
            ...
            <div class="main-content">
                ...
                <!-- Login Modal -->
                <div class="modal fade" id="login_modal" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" name="upload" class="btn btn-primary m-t-15 waves-effect">Upload</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO files (name,ext,date,file) VALUES ('" . $name . "', '" . $imageFileType . "',CURDATE(),'" . basename($_FILES["file"]["name"]) . "')";
